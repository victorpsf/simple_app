...
namespace RecorteDeCoração.Model
{
    internal class Arquivo
    {
        ...
        public Arquivo(long id, string nome, string extensao, long tamanho, byte[] binario, DateTime criado_em) : this(id, nome, extensao, tamanho, binario)
        {
            this.criado_em = criado_em;
        }

        public Arquivo(long id, string nome, long tamanho, DateTime criado_em) {
            this.id = id;
            this.nome = nome;
            this.tamanho = tamanho;
            this.criado_em = criado_em;
