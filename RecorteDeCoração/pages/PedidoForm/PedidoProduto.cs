...
namespace RecorteDeCoração.Pages.PedidoForm
{
    public partial class PedidoProduto : Form
    {
        ...
        //    if (this.produto.Imagem == null) return;
        //    this.pictureBox1.Image = FileController.BytesToBitmap(this.produto.Imagem.Binario, this.pictureBox1.Width, this.pictureBox1.Height);
        //}
        ...
        //        this.createForm.SetPedidoProduto(new ProdutoPedido(this.produto, Convert.ToInt32(this.numericUpDown1.Value)));
